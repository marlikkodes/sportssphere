...
exports.signup = async ({ name, email, password, passwordConfirm, role, sportsPreferences, phone, dateOfBirth }) => {
   // Validation
   ...
   try {
      ...
      console.log("Email verification setup failed, but user created successfully");
   }
